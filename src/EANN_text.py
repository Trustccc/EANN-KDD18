...
def load_data(args):
    ...
    # print(train[4][0])
    word_vector_path = '/home/ubuntu/fake/data/weibo/word_embedding.pickle'
...
if __name__ == '__main__':
    ...
    train = '/home/ubuntu/fake/data/weibo/train.pickle'
    test = '/home/ubuntu/fake/data/weibo/test.pickle'
    output = '/home/ubuntu/fake/data/weibo/output/'
